...
class Perceptron():
    ...
    def update_weight_one_step(self,act_g,feat_g,act_l_g,act_b,feat_b,act_l_b):
        ...
        g_feats_indices = list(map(self.model.feature_codebook[act_g_idx].get_default_index,feat_g))
        ...
        b_feats_indices = list(map(self.model.feature_codebook[act_b_idx].get_default_index,feat_b))
